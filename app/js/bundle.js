...
/***/ "./app/js/modules/getResources.js":
/*!****************************************!*\
  !*** ./app/js/modules/getResources.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "getResouces": () => (/* binding */ getResouces)
/* harmony export */ });
/* harmony import */ var regenerator_runtime_runtime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! regenerator-runtime/runtime.js */ "./node_modules/regenerator-runtime/runtime.js");
...
var getResouces = /*#__PURE__*/function () {
  var _getResouces = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  function getResouces(_x) {
    return _getResouces.apply(this, arguments);
  }
...
var PopUp = /*#__PURE__*/function () {
  ...
  _createClass(PopUp, [{
      ...
      if (this.popUp) {
        document.addEventListener('click', function (e) {
          ...
          if (clickedElement) {
            ...
            this.popUpContainer = document.querySelector("[data-target=\"".concat(target, "\"]"));
            this.open();
            return;
          }
    ...
    value: function open() {
      ...
      this.popUp.style.setProperty('--transactionTime', "".concat(this.speed / 1000, "s"));
...
var addBtn = document.querySelector('.fast__addBtn');
var tag = document.querySelector('.closeTag');
addBtn.addEventListener('click', function (e) {
  var classTag = 'closeTag';

  if (tag.classList.contains(classTag)) {
    this.classList.add('active');
    tag.classList.remove(classTag);
  } else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "lastTransaction": () => (/* binding */ lastTransaction)
/* harmony export */ });
...
/* harmony import */ var _getResources_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../getResources.js */ "./app/js/modules/getResources.js");
...
(0,_getResources_js__WEBPACK_IMPORTED_MODULE_5__.getResouces)('http://localhost:3000/cards').then(function (data) {
  data.forEach(function (_ref) {
    var colorClass = _ref.colorClass,
        src = _ref.src,
        alt = _ref.alt,
        balance = _ref.balance,
        cardHolder = _ref.cardHolder,
        finLogo = _ref.finLogo,
        finLogoAlt = _ref.finLogoAlt,
...
(0,_getResources_js__WEBPACK_IMPORTED_MODULE_5__.getResouces)('http://localhost:3000/overview').then(function (data) {
  data.forEach(function (_ref) {
    var title = _ref.title,
        balance = _ref.balance,
        percent = _ref.percent,
        lastMonth = _ref.lastMonth,
        plusMinus = _ref.plusMinus,
        parentSelector = _ref.parentSelector;
...
(0,_getResources_js__WEBPACK_IMPORTED_MODULE_5__.getResouces)('http://localhost:3000/tags').then(function (data) {
  data.forEach(function (_ref) {
    var colorTag = _ref.colorTag,
...
/* harmony import */ var _getResources_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../getResources.js */ "./app/js/modules/getResources.js");
/* harmony import */ var _swipers_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../swipers.js */ "./app/js/modules/swipers.js");
...
(0,_getResources_js__WEBPACK_IMPORTED_MODULE_6__.getResouces)('http://localhost:3000/last-transactions').then(function (data) {
  data.forEach(function (_ref) {
    var src = _ref.src,
        alt = _ref.alt,
        store = _ref.store,
        date = _ref.date,
        cardsPay = _ref.cardsPay,
        cardsPayAlt = _ref.cardsPayAlt,
  ...
  setTimeout(function () {
    _swipers_js__WEBPACK_IMPORTED_MODULE_7__.lastTransaction.init();
  }, 0);
});
new LastTransactions("./img/categories-icons/gamepad.svg", "gamepad", "Apple store", "05.01.2020", "./img/cards/visa-card-red.svg", "card", "*4300", "Credit card", 135, "- ", ".last-transaction__table").render(); // new LastTransactions(
...
/* harmony import */ var _modules_getResources_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/getResources.js */ "./app/js/modules/getResources.js");
/* harmony import */ var _modules_templates_cards_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/templates/cards.js */ "./app/js/modules/templates/cards.js");
/* harmony import */ var _modules_templates_overview_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/templates/overview.js */ "./app/js/modules/templates/overview.js");
/* harmony import */ var _modules_templates_tags_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/templates/tags.js */ "./app/js/modules/templates/tags.js");
/* harmony import */ var _modules_templates_transactions_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/templates/transactions.js */ "./app/js/modules/templates/transactions.js");
/* harmony import */ var _modules_forms_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/forms.js */ "./app/js/modules/forms.js");
